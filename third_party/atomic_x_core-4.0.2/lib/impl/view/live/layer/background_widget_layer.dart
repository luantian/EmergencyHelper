...
import 'package:atomic_x_core/impl/view/live/item/background_widget.dart';
...
class BackgroundWidgetLayer extends StatelessWidget with SeatLayoutMixin {
  ...
  BackgroundWidgetLayer({super.key, required this.controller, required this.layoutSize, this.videoWidgetBuilder});
